...
\pagebreak
    \subsection{Acidité et basicité}
        ...
        \begin{itemize}
            \item \textbf{Brönsted-Lowry} : un acide est composé de type \ce{H_n A} qui peut transférer un \ce{H^+} à une base \ce{B}
        ...
        \subsubsection{Force}
            ...
            Exemple :\\
            \ce{CH_3-C#CH + OH^- <- CH_3-C#C^- + H_2O}\\
            pKa(\ce{CH_3-C#CH}) = 25\\
            pKa(\ce{H_2O}) = 15.7\\\\
            \ce{CH_3-C#CH + NH_2^- -> CH_3-C#C^- + NH_3}\\
            pKa(\ce{CH_3-C#CH}) = 25\\
            pKa(\ce{NH_3}) = 36\\
...
\pagebreak
    \subsection{Facteurs influençant l'acidité ou la basicité}
        ...
        \begin{itemize}
            ...
            Exemple : \ce{CH_4} $<$ \ce{NH_3} $<$ \ce{H_2O} $<$ \ce{HF}
            \item Sa taille\\
            Exemple : \ce{HF} $<$ \ce{HCl} $<$ \ce{HBr} $<$ \ce{HI}
            \item Sa résonance (mésomérie)\\
            Exemple : Cyclohexanol $<$ Phénol
            \item Son effet inductif\\
            Exemple : \ce{CH_3-COOH} $<$ \ce{CH_2Cl-COOH} $<$ \ce{CHCl_2-COOH} $<$ \ce{CCl_3-COOH}
            \item Ses orbitales\\
            Exemple : \ce{CH_3-CH_3} ($sp^3$) $<$ \ce{CH_2=CH_2} ($sp^2$) $<$ \ce{CH#CH} ($sp$)
        \end{itemize}
...
\section{CM4 : Réactivité des alcanes, alcènes et alcynes}
    ...
    \subsection{Structures et propriétés physiques des alcanes}
        \begin{itemize}
            \item Les alcanes ont une formule \ce{C_n H_{2n+2}}, tandis que les alcanes cycliques ont une formule \ce{C_n H_{2n}}.
    ...
    \subsection{Structures et propriétés physiques des alcènes}
        \begin{itemize}
            \item Les \textbf{alcènes} ont une formule \ce{C_n H_{2n}} et contiennent une double liaison \ce{C=C}
            \item Les \textbf{diènes} disposent de deux liaisons doubles \ce{C=C} qui peuvent être :
            \begin{itemize}
                \item Cumulées : \ce{C=C=C}
                \item Conjuguées : \ce{C=C-C=C}
                \item Isolées : \ce{C=C-C-C=C}
            \end{itemize}
...
\pagebreak
        \subsubsection{Hydratation}
            L'hydratation d'un alcène (ajout d'un \ce{H} et d'un \ce{OH}) doit passer par un catalyseur (acide), car l'eau n'est pas un acide suffisamment puissant, tandis que l'hydronium bien :
            \insertslide{Slides/CM4}{30}
            Lorsque l'alcène est asymétrique, la règle de Markovnikov s'applique !
        
        \subsubsection{Halogénation}
            La liaison double est cassée, et les deux électrons libres se lient avec un halogène (\ce{Cl}, \ce{Br}, ...)\\
